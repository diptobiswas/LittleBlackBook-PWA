...
export default function ResourceUpdateForm(props) {
  ...
  const [resourceRecord, setResourceRecord] = React.useState(resourceModelProp);
  React.useEffect(() => {
    ...
    >
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || resourceModelProp)}
