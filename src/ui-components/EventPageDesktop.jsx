...
export default function EventPageDesktop(props) {
  ...
  return (
    <View
      ...
      {...getOverrideProps(overrides, "EventPageDesktop")}
      {...rest}
    >
      <Image
        width="61.67%"
        ...
        objectFit="cover"
        src={events?.Image}
        {...getOverrideProps(overrides, "featuredimage37652974")}
      ></Image>
      <Flex
        gap="32px"
        direction="column"
      ...
      >
        ...
        >
          <View
            ...
            {...getOverrideProps(overrides, "featuredimage38042732")}
          ></View>
          <Text
            fontFamily="Inter"
            fontSize="64px"
