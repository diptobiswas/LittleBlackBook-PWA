...
export default function EventPage2(props) {
  ...
  return (
    <View
      ...
      {...getOverrideProps(overrides, "EventPage2")}
      {...rest}
    >
      <Image
        width="61.67%"
        ...
        {...getOverrideProps(overrides, "featuredimage38572803")}
      ></Image>
      <Flex
        gap="32px"
        direction="column"
      ...
      >
        ...
        >
          <View
            ...
            {...getOverrideProps(overrides, "featuredimage38572812")}
          ></View>
          <Text
            fontFamily="Inter"
            fontSize="64px"
